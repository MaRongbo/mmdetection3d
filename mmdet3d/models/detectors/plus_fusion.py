...
class PlusFusion(MVXTwoStageDetector):
    ...
    def __init__(self,used_sensors=None, use_offline_img_feat=True, img_view_transformer=None, **kwargs):
        super(PlusFusion, self).__init__(**kwargs)
    ...
    def extract_feat(self, points, img, img_feature, lidar2img, lidar2camera, camera_intrinsics, radar, img_metas):
        ...
        fused_feats = self.img_view_transformer(points, img_feats, pts_feats, rad_feats, img_metas, lidar2img)
        return fused_feats
    
    def forward_outs(self, fused_feats):
    ...
    def forward_train(self,
        ...
        fused_feats = self.extract_feat(points, img, offline_img_features, lidar2img, lidar2camera, camera_intrinsics, radar, img_metas)
        # calculate loss
        losses = dict()
        loss_fused = self.forward_mdfs_train(fused_feats, gt_bboxes_3d,
    ...
    def forward_mdfs_train(self,
                          ...
                          img_metas,
                          gt_bboxes_ignore=None):
        outs = self.forward_outs(fused_feats)
    ...
    def simple_test(self, points, img_metas, img=None, radar=None, rescale=False, img_feature=None, lidar2img=None, lidar2camera=None, camera_intrinsics=None):
        ...
        fused_feats = self.extract_feat(points, img, img_feature, lidar2img, lidar2camera, camera_intrinsics, radar, img_metas)
    ...
    def simple_test_mdfs(self, fused_feats, img_metas, rescale=False):
